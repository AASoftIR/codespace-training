...
const projectList = [
  {
    title: "🚀 Timeline Madness",
    description:
      "👋 Welcome, brave coder, to the HeroAPI Timeline—where jokes, confetti, and random years collide! 🌀🎊.",
    url: "https://github.com/AASoftIR/timeline-tailwind",
  },
  {
    title: "Gemini Chat Bot",
    description:
      "It is Clear Enough!",
    url: "https://chat-gemini-st.streamlit.app/",
  },
  {
    title: "🖼️ React Image Viewer",
    description:
    ...
    url: "https://url-to-img-reactjs.vercel.app/",
  },
  {
    title: "URL Shortener API",
    description:
      "A Shortner!!!.",
    url: "https://github.com/AASoftIR/encore-url-shortner",
  },
